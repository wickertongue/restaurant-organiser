...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Booking booking2 = new Booking("21:00", "2019-12-02", 6, customer2, table2);
        bookingRepository.save(booking2);

        Booking booking3 = new Booking("13:00", "2019-12-02", 3, customer2, table2);
        bookingRepository.save(booking3);

        Booking booking4 = new Booking("09:00", "2019-12-02", 9, customer2, table5);
